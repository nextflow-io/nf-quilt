...
class FileHelperGsTest extends Specification {
    ...
    def 'should strip ending slash' () {
        ...
        and:
        def gsFolder = 'quilt://my-bucket/foo' as Path
        def gsNested = 'quilt://my-bucket/foo/bar/' as Path
